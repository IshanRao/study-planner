### I tend to include my learnings about REACT, NextJS and the libraries used when building this project in this document
...
## Fix: 
# Hid either of the two buttons based on the isEditing state